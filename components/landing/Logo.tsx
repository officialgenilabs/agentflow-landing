...
export function Logo({ size = 36, width, height, className = "", ...props }: LogoProps) {
  const w = width || size;
  const h = height || (size * 12) / 8; // Preserve 800x1200 aspect ratio (2:3)
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="logo-mint-glow-grad" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#C2FCE5" />
          <stop offset="50%" stopColor="#00E599" />
          <stop offset="100%" stopColor="#008A5E" />
        </linearGradient>
        <filter id="logo-subtle-bloom" x="-20%" y="-20%" width="140%" height="140%">
      ...
      <g filter="url(#logo-subtle-bloom)" transform="translate(100, 150)">
        ...
        <path 
          ...
          stroke="url(#logo-mint-glow-grad)" 
          strokeWidth="48" 
          strokeLinecap="round" 
