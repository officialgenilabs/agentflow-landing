      ...
      <div className="section-shell">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          ...
          <ScrollReveal delay={2}>
            <div className="rounded-2xl border border-secondary/20 bg-secondary-soft p-6 md:p-8 h-full">
              <span className="inline-block rounded-full bg-secondary/20 border border-secondary/30 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-secondary mb-6">
              ...
              <div className="space-y-4">
                {beforeAfter.after.items.map((item) => (
                  <div key={item} className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-secondary leading-6">{item}</p>
                  </div>
                ))}
              </div>
            </div>
