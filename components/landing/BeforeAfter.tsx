      ...
      <div className="section-shell">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          ...
          <ScrollReveal delay={2}>
            <div className="rounded-2xl border border-teal/20 bg-teal-soft p-6 md:p-8 h-full">
              <span className="inline-block rounded-full bg-teal/20 border border-teal/30 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-teal mb-6">
